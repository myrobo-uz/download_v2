"""
Ishga tushirish:
  python run.py           — ikkalasi birga (tavsiya)
  python run.py --user    — faqat user bot
  python run.py --admin   — faqat admin bot
"""
import asyncio
import sys
from pathlib import Path

# Loyiha ildizini sys.path ga qo'shamiz — import ishlashi uchun
